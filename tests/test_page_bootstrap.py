...
from genro_pages.menu import MenuBuilder
from genro_pages.page_document import PageDocument
from genro_pages.pages.playground import PlaygroundPage
from genro_pages.pages.widgets import WIDGET_PAGES
...
class TestPageBootstrap:
    def test_document_is_built_in_python_without_main_recipe(self):
        ...
        with patch("genro_pages.application.PageDocument", ExtendedDocument):
    ...
    def test_startup_bag_round_trips_safely_through_html(self):
        ...
        check = BootstrapChecks()
        with patch("genro_pages.application.PageDocument", ProbeDocument):
            html = check.get_document(HelloWorldPage(client_modules=check.modules))
