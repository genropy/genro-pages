...
setupDom();
const {Application, HtmlBuilder, getCollection} = await import(new URL('genro-dom-js/src/index.js', base));
...
for (const name of collections) {
    await import(new URL(`genro-dom-js/src/collections/${name.toLowerCase()}.js`, base));
}
