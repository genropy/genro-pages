...
- [>] **Phase 1**: Generate the page document and drive startup from typed configuration
  ...
  > WIP: done: document/config implementation, contract bodies, generated-shell fixtures and docs; 70 unaffected pages tests and 128 DOM tests green | missing: details grammar correction #39, full integration and browser checks, human QA | next: after #39 lands run all pages tests and browser startup | commit: 97c134b
  - Run: opus / high
