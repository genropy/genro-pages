...
import {registerCollection, webcomponent} from 'genro-dom-js';
    ...
    defineComponents() {
        ...
        class CodeMirrorElement extends HTMLElement {
            ...
            async connectedCallback() {
                ...
                this.fallback.setAttribute('aria-label', this.getAttribute('aria-label') || 'Codice');
                this.fallback.addEventListener('input', () => {
                    this._value = this.fallback.value;
                    this.dispatchEvent(new Event('change', {bubbles: true, composed: true}));
                });
                this.shadowRoot.replaceChildren(style, this.fallback);
                try {
                    ...
                    this.editor = new EditorView({parent: this.shadowRoot, doc: this._value,
                        extensions: [basicSetup, (language.xml || language.javascript)(),
                            ...
                            EditorView.contentAttributes.of({tabindex: '0', 'aria-label': this.getAttribute('aria-label') || 'Codice'}),
